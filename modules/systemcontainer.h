...
class SystemContainer : public QObject
{
    Q_OBJECT
public:
    explicit SystemContainer(QObject *parent = 0, VariableHandler* varHandler = 0, QHash<QString, QVariant> *systemElement = 0);
    ~SystemContainer();
    ...
    void expandInheritance(QList<QVariant> *systemsList);
signals:
